...
// Pass-throughs to handle other common SCORM 2004 wrapper versions.
initializeCommunication = doInitialize;
terminateCommunication = doTerminate;
storeDataValue = doSetValue;
retrieveDataValue = doGetValue;
