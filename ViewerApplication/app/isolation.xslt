...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <xsl:template match="proceduralStepBROKEN[not(@id)]">
        ...
        <xsl:choose>
            ...
            <xsl:when test="child::proceduralStep">
                ...
                <xsl:variable name="nextRefId">
                    ...
                    <xsl:value-of select="generate-id(child::para)"/>
                </xsl:variable>
                                        ...
                                        <tr>
                                            <td>
                                                <font class="indentMarginLeft">
                                                    <strong>
                                                        <xsl:apply-templates
                                                                select="//warning[@id=$warnRef]/warningAndCautionPara"/>
                                                    </strong>
                                                </font>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <font class="indentMarginLeft">
                                                    <strong>
                                                        <xsl:apply-templates
                                                                select="//caution[@id=$cautionRef]/warningAndCautionPara"/>
                                                    </strong>
                                                </font>
                                            </td>
                                        </tr>
            ...
            <xsl:otherwise>
                ...
                <xsl:variable name="nextRefId">
                    ...
                    <xsl:value-of select="generate-id(preceding-sibling::para)"/>
                </xsl:variable>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="parent::proceduralStep">
                                        ...
                                        <xsl:variable name="grandParentCount">
                                            <xsl:value-of
                                                    select="count(parent::node()/parent::node()/preceding-sibling::proceduralStep)+1"/>
                                        </xsl:variable>

                                        <xsl:variable name="parentCount">
                                            <xsl:value-of
                                                    select="count(parent::node()/preceding-sibling::proceduralStep)+1"/>
                                        </xsl:variable>
                                        ...
                                        <xsl:variable name="finalCount">
                                            <xsl:choose>
                                                <xsl:when test="$grandParentCount > 1">
                                                    <xsl:value-of
                                                            select="concat(concat(concat($grandParentCount,'.'), concat($parentCount,'.')),$stepCounter)"/>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:variable name="tempCount" select="concat($parentCount,'.')"/>
                    ...
                    <xsl:otherwise>
                        ...
                        <xsl:choose>
                            <xsl:when test="../following-sibling::*[position()=1][name()='proceduralStep']">
                                <xsl:variable name="nextElementNode"
                                              select="parent::node()/following-sibling::proceduralStep/@id"/>
                                ...
                                <div id="{$step_id}" style="display: none;">
                                    ...
                                    <br/>
                                    <div>
                                        <a href="#{$nextElementNode}"
                                           onclick="show_hide_div('{$step_id}','{$nextElementNode}')">Next
                                        </a>
                                        <br/>
                                    </div>
                                </div>
                            ...
                            <xsl:otherwise>
                                ...
                                <div id="{$step_id}" style="display: none;">
                                    ...
                                    <xsl:text> </xsl:text>
                                    <xsl:apply-templates
                                            select="para | note | table | figure | ../../closeRqmts/reqCondGroup "/>
    ...
    <xsl:template match="proceduralStep[not(@id)]">
        ...
        <xsl:choose>
            <xsl:when test="child::proceduralStep">
                ...
                <li id="{$step_id}" style="visibility:{$styler}">
                    <div>
                        <p>
                            <xsl:value-of select="para"/>
                        </p>
                        <a href="#mainProcedure" onclick="show_hide_div('{$step_id}','{$nextRefId}')">Next</a>
                        <br/>
                    </div>
                    <ol>
                        <xsl:apply-templates/>
    ...
    <!-- ********************************************************************************************************* -->
    <xsl:template match="proceduralStepBROKEN">
